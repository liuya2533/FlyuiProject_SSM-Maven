...
public class MailUtil {
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String mailActiveCode) throws Exception {
        ...
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "妞妞用户", "UTF-8"));
        // 4. Subject: 邮件主题
        message.setSubject("用户验证", "UTF-8");
        String activeUrl="http://localhost:8080/DemoWar/user/activeemail?mailcode="+mailActiveCode;
