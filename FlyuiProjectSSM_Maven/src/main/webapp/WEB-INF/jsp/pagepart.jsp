	...
	<script type="text/javascript">
	   $(function(){
		   $("#page").pagination({
			    ...
			    nextBtnText:'下一页',
			    remote: {
			        url: '${pageContext.request.contextPath }/article/partpage',
			        method:'get',
	...
	<body>
		...
		<div id="nav">
			<ul>
				...
				<li id="rart" ><a  class="rarta" href="${pageContext.request.contextPath }/page/gorelease">发表动态</a></li>
			</ul>
		</div>
		...
		{{each list as value i}}
          <li  id="zongb" class="artlist">
					    ...
					    <p class="arttitle">
					    	...
					    	<a href="${pageContext.request.contextPath }/article/info/${value.artorcommid}">{{value.title}}</a>
					    </p>
					    <p class="artinfo">
					    	<a href="${pageContext.request.contextPath }/                                                                                                                                                                                                                                                                                                                                                                                                              ">{{value.nickname}}</a>
