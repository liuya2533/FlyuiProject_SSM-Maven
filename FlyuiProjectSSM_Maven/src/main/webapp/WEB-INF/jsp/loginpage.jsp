	...
	<body>
		<div id="title">
			<ul>
				...
				<li class="option op"><a href="${ pageContext.request.contextPath }/page/reg" class="title-li-a">&nbsp;&nbsp;注册</a></li>
			</ul>
		</div>
		<div class="layui-container ">
			<div class="fly-panel fly-panel-user">
				<ul class="layui-tab-title">
					...
					<li class="layui-zuche"><a href="${ pageContext.request.contextPath }/page/reg">注册</a></li>
				</ul>
				<div>
