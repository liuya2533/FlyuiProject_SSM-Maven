	...
	<head>
	    ...
	    $(function(){
	    	...
	    	$('#fly-file').change(function(){
	    		...
	    		$.ajax({
	    			url:'${pageContext.request.contextPath}/user/loadup',
	    			data:formdata,
	    			type:'post',
	    			cache:false,
	    			contentType:false,
		...
		<div id="content">
			...
			<div class="content-text">
				...
				<div style=" padding: 0px 20px;">
					<div id="myMessage">
						<form action="${pageContext.request.contextPath}/user/modifyinfo" method="get">
							...
							<div class="text-form-tab">
								<label>昵称</label>
								<input class="text-form-text" type="text" name="nickname"  value="" />
							...
							<div class="text-form-tab">
								<label>城市</label>
								<input class="text-form-text" type="text" name="city" />
