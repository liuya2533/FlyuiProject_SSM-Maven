	...
	<body style="height: 2000px;">
		<div id="title">
			<ul>
				...
				<a id="item" href="${pageContext.request.contextPath }/page/setpage"><span style="color:#fff;">${userinfo.nickname}</span><img  class="title-img" src="${pageContext.request.contextPath }/upload/${userinfo.head_url}"/>
					...
					<li><a href="">我的消息</a></li>
					<li class="title-item-li"><a href="${pageContext.request.contextPath }/user/userinfo" >我的主页</a></li>
		...
		<div id="nav">
			<ul>
				...
				<li id="rart"><a href="${pageContext.request.contextPath }/page/gorelease" class="rarta">发表动态</a></li>
				</c:if>
			</ul>
		</div>
		<div id="content">
			<div class="content-left-top">
				<div class="content-panel">
					...
					<div class="content-div-padding " style="font-size:16px; overflow:auto; font-weight:400;">
						${detail_map.topic_markdown_html }
					</div>
				</div>
			</div>
						...
						<ul>
							<c:forEach items="${thisweek }" var="thismap">
								<li class="thisweek-li">
									<a href="${pageContext.request.contextPath }/article/info/${thismap.artorcommid}" style="color:black;">${thismap.title}</a>
			...
			<div id="reply">
				<div class="content-panel">
					...
					<script type="text/html" id="replymodel">
						...
						<li class="reply-li-text " style="left:20px;" >
							<div>{{content }}</div>
						</li>
						<li class="" style="top: 20px; left:20px;">
							<a ><img src="${pageContext.request.contextPath }/img/dianzan.PNG"/></a><span>0</span>
					...
					<ul class="reply-ul"  >
						...
						<li class="reply-li-text " style="margin-left:20px;">
							<div>${remap.content }</div>
						</li>
						<li class="" style="top: 20px; margin-left:20px;">
