	...
	<head>
		...
		$(function(){
			...
			$('#lemail').blur(function(){
				...
				$.ajax({
				    url:'${pageContext.request.contextPath}/user/checkemil',
					type:'get',
	...
	<body>
		<div id="title">
			<ul>
				...
				<li class="option op"><a href="${pageContext.request.contextPath }/page/login" class="title-li-a">&nbsp;&nbsp;登入</a></li>
		...
		<div class="layui-container ">
			<div class="fly-panel fly-panel-user">
				<ul class="layui-tab-title">
					<li class="layui-this"><a href="${pageContext.request.contextPath }/page/login">登入</a></li>
					<li class="layui-zuche">注册</li>
				</ul>
				<div class="layui-form-title">
						<div>
							<form id="lform" action="${pageContext.request.contextPath }/user/reg" method="post">
