	...
	<body >
		<div id="title">
			<ul>
				...
				<a href="${ pageContext.request.contextPath }/page/login" class="title-li-a">&nbsp;&nbsp;登入</a>
				<a href="${ pageContext.request.contextPath }/page/reg" class="title-li-a">&nbsp;&nbsp;注册</a>
				</li>
				</c:if>
			    <c:if test="${userinfo!=null}">
				<li id="logimg"><a href=""><img id="logimg" src="${pageContext.request.contextPath }/img/logo.png"/></a></li>
				...
				<li class="kuang"><a href="" class="title-li-a"><img  src="${pageContext.request.contextPath }/img/ui.jpg"/>&nbsp;&nbsp;框架</a></li>
				<li class="title-user">
				<a id="item" href="${pageContext.request.contextPath }/page/setpage"><span style="color:#fff;">${userinfo.nickname}</span><img  class="title-img" src="${pageContext.request.contextPath }/upload/${userinfo.head_url}"/>
				    <ul class="title-item">
					<li><a href="#">用户中心</a></li>
					<li class="title-item-li"><a href="${pageContext.request.contextPath }/page/setpage">基本设置</a></li>
					<li><a href="#">我的消息</a></li>
					<li class="title-item-li"><a href="${pageContext.request.contextPath }/user/userinfo/${userinfo.id}" >我的主页</a></li>
		...
		<div id="nav">
			<ul>
				...
				<li id="rart"><a href="${pageContext.request.contextPath }/page/gorelease" class="rarta">发表动态</li>
				</c:if>
			</ul>
		</div>
		<div id="top">
			<div id="tleft">
				...
				<li id="zhiding">置顶</li>
				  <c:if test="${goodlist!=null }">
					...
					<li class="artlist">
						<div ><a href="${pageContext.request.contextPath }/user/userinfo/${map.userid}"><img src="${pageContext.request.contextPath }/upload/${map.head_url}"></a>
					    </div>
					    <p class="arttitle">
					    	<span>${map.typename }</span>
					    	<a href="${pageContext.request.contextPath }/article/info/${map.id}">${map.title }</a>
					    </p>
					    <p class="artinfo">
					    	<a href="${pageContext.request.contextPath }/user/userinfo/${map.userid}">${map.nickname }</a>
		...
		<div id="content">
			<div id="zonghe">
				...
				<div class="more-solve">
					<a class="more-solve-a" href="${ pageContext.request.contextPath }/page/partpage">更多求解</a>
				</div>
			</div>
			<div id="week">
			...
			<c:forEach items="${userlist }" var="user">
				<li><a href="${pageContext.request.contextPath }/user/userinfo/${user.userid}">
			...
			<div>
				...
				<c:forEach items="${thisweek }" var="thismap">
					<li class="thisweek-li">
						<a href="${pageContext.request.contextPath }/user/userinfo/${thismap.artorcommid}" style="color:black;">${thismap.title}</a>
